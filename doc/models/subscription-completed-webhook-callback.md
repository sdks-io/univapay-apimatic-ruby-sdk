...
| `event` | `String` | Required, Constant | Event type discriminator — always `subscription_completed` for this callback.<br><br>**Value**: `'subscription_completed'` |
...
```ruby
subscription_completed_webhook_callback = SubscriptionCompletedWebhookCallback.new(
