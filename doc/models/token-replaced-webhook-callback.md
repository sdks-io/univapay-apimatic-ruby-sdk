...
| `event` | `String` | Required, Constant | Event type discriminator — always `token_replaced` for this callback.<br><br>**Value**: `'token_replaced'` |
...
```ruby
token_replaced_webhook_callback = TokenReplacedWebhookCallback.new(
