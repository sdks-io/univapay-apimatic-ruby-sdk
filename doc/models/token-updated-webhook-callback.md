...
| `event` | `String` | Required, Constant | Event type discriminator — always `token_updated` for this callback.<br><br>**Value**: `'token_updated'` |
...
```ruby
token_updated_webhook_callback = TokenUpdatedWebhookCallback.new(
