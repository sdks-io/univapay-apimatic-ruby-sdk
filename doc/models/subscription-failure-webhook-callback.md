...
| `event` | `String` | Required, Constant | Event type discriminator — always `subscription_failure` for this callback.<br><br>**Value**: `'subscription_failure'` |
...
```ruby
subscription_failure_webhook_callback = SubscriptionFailureWebhookCallback.new(
