...
| `event` | `String` | Required, Constant | Event type discriminator — always `subscription_payment` for this callback.<br><br>**Value**: `'subscription_payment'` |
...
```ruby
subscription_payment_webhook_callback = SubscriptionPaymentWebhookCallback.new(
