...
| `event` | `String` | Required, Constant | Event type discriminator — always `token_cvv_auth_check_updated` for this callback.<br><br>**Value**: `'token_cvv_auth_check_updated'` |
...
```ruby
token_cvv_auth_check_updated_webhook_callback = TokenCvvAuthCheckUpdatedWebhookCallback.new(
