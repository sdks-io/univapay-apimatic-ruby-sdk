...
| `event` | `String` | Required, Constant | Event type discriminator — always `charge_updated` for this callback.<br><br>**Value**: `'charge_updated'` |
...
```ruby
charge_updated_webhook_callback = ChargeUpdatedWebhookCallback.new(
