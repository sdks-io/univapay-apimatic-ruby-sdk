...
| `event` | `String` | Required, Constant | Event type discriminator — always `subscription_suspended` for this callback.<br><br>**Value**: `'subscription_suspended'` |
...
```ruby
subscription_suspended_webhook_callback = SubscriptionSuspendedWebhookCallback.new(
