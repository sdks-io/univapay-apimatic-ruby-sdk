...
| `event` | `String` | Required, Constant | Event type discriminator — always `token_created` for this callback.<br><br>**Value**: `'token_created'` |
...
```ruby
token_created_webhook_callback = TokenCreatedWebhookCallback.new(
