...
| `event` | `String` | Required, Constant | Event type discriminator — always `subscription_canceled` for this callback.<br><br>**Value**: `'subscription_canceled'` |
...
```ruby
subscription_canceled_webhook_callback = SubscriptionCanceledWebhookCallback.new(
