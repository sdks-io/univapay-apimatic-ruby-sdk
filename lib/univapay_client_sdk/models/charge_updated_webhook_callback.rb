...
module UnivapayClientSdk
  ...
  class ChargeUpdatedWebhookCallback < BaseModel
    SKIP = Object.new
    ...
    # Event type discriminator — always `charge_updated` for this callback.
    # @return [String]
    attr_reader :event
    ...
    def self.from_hash(hash)
      ...
      ChargeUpdatedWebhookCallback.new(id: id,
                                       created_on: created_on,
                                       data: data,
                                       additional_properties: additional_properties)
    end
    ...
    # @param [ChargeUpdatedWebhookCallback | Hash] The value against the validation is performed.
